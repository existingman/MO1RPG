    ...
    public static class ImageData
    {
        ...
        public static void Initialise()
        {
            foreach (ImageType type in Enum.GetValues(typeof(ImageType)))
            {
                ...
                string filename = Path.Combine(Data.BaseDir, "images");
                filename = Path.Combine(filename, "blue.PNG");
                BlueTint = Image.FromFile(filename);

                filename = Path.Combine(Data.BaseDir, "images");
                filename = Path.Combine(filename, "no.PNG");
                No = Image.FromFile(filename);
            }
        }
